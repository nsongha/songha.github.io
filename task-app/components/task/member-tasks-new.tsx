...
export const MemberTasksNew: React.FC = () => {
      ...
      <div className="grid grid-cols-3 gap-3">
        <Card className="bg-orange-50 border-orange-200">
          <CardContent className="p-4">
            <div className="text-xs text-orange-900 mb-1">Today</div>
            <div className="text-3xl font-bold text-orange-900">{todayTasks.length}</div>
          </CardContent>
        </Card>
        <Card className="bg-blue-50 border-blue-200">
          <CardContent className="p-4">
            <div className="text-xs text-blue-900 mb-1">To Do</div>
            <div className="text-3xl font-bold text-blue-900">{todoTasks.length}</div>
          </CardContent>
        </Card>
